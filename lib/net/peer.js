...
Peer.prototype._init = function _init() {
  ...
  this.parser.on('deparse', (packet) => {
    // console.log('in Peer deparse');
    this.emit('deparse', packet)
  });
...
Peer.prototype.getBlock = function getBlock(hashes) {
  console.log('will get block');
  console.log('block type requested:', this.blockType());
